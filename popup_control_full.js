...
$(window).load(function() {
		if(document.cookie.indexOf("adf") == -1)
		{
			...
			$("#myModal").html("<a href='http://cameraanninh24h.com.vn?utm_source=google&utm_medium=Kh%C3%B4ng%20ph%E1%BA%A3i%20tr%E1%BA%A3%20ti%E1%BB%81n&utm_campaign=ads_trackling&utm_term=seo&utm_content=seo' target='_blank'><img src='http://cameraanninh24h.com.vn/image/data/logo/logo_.jpg' width='500px'/>Lắp đặt camera quan sát</a>. Giá Tại Kho. <h2><a class='close-linhnguyen-modal'>X</a></h2>");
